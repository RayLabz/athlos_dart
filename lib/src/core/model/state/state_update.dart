...
abstract class StateUpdate<EntityType extends Entity, TerrainCellType extends TerrainCell> {
  ...
  Map<String, TerrainCellType> terrainCellUpdates = {}; // A map of terrain cell hashes to their updated properties, representing the changes to the terrain cells in the game world since the last state update.
